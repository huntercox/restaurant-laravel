...
<template>
  <Head><title>Admin: Create New Option</title></Head>

  <AuthenticatedLayout>
    <div class="bg-red-100 py-4 mb-3">
      <div class="max-w-7xl mx-auto px-4 sm-px-6 lg-px-8 flex justify-between items-center">

        <h1 class="text-xl font-black">Create New Option</h1>
      </div>
    </div>

    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
      <form @submit.prevent="form.post(route('admin.options.store'), { onSuccess: () => form.reset() })">
        <label for="name">
          Name
        ...
        <PrimaryButton class="block mt-10 bg-red-500 text-xl">Add Option</PrimaryButton>
      </form>
    </div>
