                        ...
                        <div class="flex w-full h-full align-center justify-between">
                            <div class="flex justify-start">
                                ...
                                <div class="shrink-0 flex items-center justify-between">
                                    <Link href="/">
                                    <ApplicationLogo
                                        class="block w-auto fill-current text-gray-800 hover:scale-125 transition-transform" />
                                    </Link>
                                </div>

                                <!-- Main Navigation -->
                                <nav
                                    class="space-x-8 sm:-my-px sm:ml-10 sm:flex items-center self-center justify-end grow-1">
