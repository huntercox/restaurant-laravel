...
const selectedDeepFriedRavioliSize = inject('selectedDeepFriedRavioliFilling');
const selectedDeepFriedRavioliFilling = inject('selectedDeepFriedRavioliFilling');

</script>

<template>
  <div>
    DeepFriedRavioliOptions.vue
